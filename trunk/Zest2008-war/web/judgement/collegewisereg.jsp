...
<f:subview id="collegewisereg">
    <rich:panel header="College Wise Registrations">
        ...
        <rich:dataTable value="#{ViewColRegBean.partlist}" var="row">
            ...
            <rich:column><f:facet name="header"><h:outputText value="View Events"/></f:facet><a4j:commandButton value="View Events" actionListener="#{ViewColRegBean.RetrieveEvents}" reRender="pm" data="#{row.partid}"/></rich:column>
